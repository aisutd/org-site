        ...
        <section className="bg-ais-light-gray py-8">
          <div className="mx-auto max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-4xl 2xl:max-w-6xl">
            <div>
              ...
              <div className="text-xl pt-2">We want to change that.</div>
            </div>
          </div>
        </section>
        <section className="bg-ais-light-gray py-8">
          <div className="mx-auto max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-4xl 2xl:max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 grid-flow-row text-2xl text-center mt-8">
              ...
              <div className="border-4 p-8 rounded-xl transition duration-400 hover:shadow-xl hover:text-white hover:bg-purple-600 border-purple-600 flex items-center justify-around">
                Demystify the field of AI.
              </div>
            </div>
          </div>
